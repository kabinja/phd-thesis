...
\begin{figure}
\centering
\subfloat[Connectivity \label{fig:changes_connectivity}]{\includegraphics[width=0.7\textwidth]{figures/evolution/changes_connectivity_class_total.pdf}}
\subfloat[Level \label{fig:changes_depth}]{\includegraphics[width=0.7\textwidth]{figures/evolution/changes_depth_total.pdf}}
...
\begin{figure}
\centering
\subfloat[Connectivity \label{fig:churn_connectivity}]{\includegraphics[width=0.7\textwidth]{figures/evolution/barplot_connectivity_class_churn.pdf}}
\subfloat[Level \label{fig:churn_depth}]{\includegraphics[width=0.7\textwidth]{figures/evolution/barplot_depth_churn.pdf}}
