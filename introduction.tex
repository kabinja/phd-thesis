...
\chapterPage{
With GUI-based applications becoming ubiquitous as a mean for users to interact with a software, the question of their correctness is of utmost importance. Yet, testing such application still poses major challenges to practitioners. 
After introducing four approaches employed when creating \gls{suit}, we introduce the challenges that come with them.
Before describing the three contributions of this dissertation, we scope to the addressed sub-challenges tackled.
}
